                        ...
                        <table class="table user-list">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">
                                        <span><i class="fa fa-check-square status-icon"></i> Delete/Update</span>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 20%;">
								<a href="#" class="table-link edit-task" data-task-id="{{ $task->id }}">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										<i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
									</span>
								</a>
								<a href="#" class="table-link danger" data-task-id="{{ $task->id }}">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
